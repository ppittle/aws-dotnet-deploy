...
namespace AWS.Deploy.CLI.UnitTests
{
    public class GetOptionSettingTests
    {
        ...
        public async Task GetOptionSettingTests_GetDisplayableChildren(string optionSetting, string childSetting, bool childValue, int displayableCount)
        {
            ...
            await _optionSettingHandler.SetOptionSettingValue(managedActionsEnabled, childValue);
        ...
        public async Task GetOptionSettingTests_ListType_InvalidValue()
        {
            ...
            await Assert.ThrowsAsync<ValidationFailedException>(async () => await _optionSettingHandler.SetOptionSettingValue(subnets, new SortedSet<string>(){ "subnet1" }));
            await Assert.ThrowsAsync<ValidationFailedException>(async () => await _optionSettingHandler.SetOptionSettingValue(securityGroups, new SortedSet<string>(){ "securityGroup1" }));
        }
        ...
        public async Task GetOptionSettingTests_ListType()
        {
            ...
            await _optionSettingHandler.SetOptionSettingValue(subnets, new SortedSet<string>(){ "subnet-1234abcd" });
