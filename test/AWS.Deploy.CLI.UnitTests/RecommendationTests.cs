...
namespace AWS.Deploy.CLI.UnitTests
{
    public class RecommendationTests
    {
        ...
        public async Task ResetOptionSettingValue_Int()
        {
            ...
            await _optionSettingHandler.SetOptionSettingValue(desiredCountOptionSetting, 2);

            Assert.Equal(2, _optionSettingHandler.GetOptionSettingValue<int>(fargateRecommendation, desiredCountOptionSetting));

            await _optionSettingHandler.SetOptionSettingValue(desiredCountOptionSetting, consoleUtilities.AskUserForValue("Title", "2", true, originalDefaultValue.ToString()));
        ...
        public async Task ResetOptionSettingValue_String()
        {
            ...
            await _optionSettingHandler.SetOptionSettingValue(ecsServiceNameOptionSetting, "TestService");
            ...
            await _optionSettingHandler.SetOptionSettingValue(ecsServiceNameOptionSetting, consoleUtilities.AskUserForValue("Title", "TestService", true, originalDefaultValue));
        ...
        public async Task ValueMappingSetWithValue()
        {
            ...
            await _optionSettingHandler.SetOptionSettingValue(environmentTypeOptionSetting, "LoadBalanced");
        ...
        public async Task ObjectMappingSetWithValue()
        {
            ...
            await _optionSettingHandler.SetOptionSettingValue(applicationIAMRoleOptionSetting, new IAMRoleTypeHintResponse {CreateNew = false,
        ...
        public async Task IsDisplayable_ManyDependencies()
        {
            ...
            await _optionSettingHandler.SetOptionSettingValue(isDefaultOptionSetting, false);
            ...
            await _optionSettingHandler.SetOptionSettingValue(createNewOptionSetting, false);
        ...
        public async Task IsDisplayable_NotEmptyOperation()
        {
            ...
            // Satisfy dependencies
            await _optionSettingHandler.SetOptionSettingValue(vpcIdOptionSetting, "vpc-1234abcd");
        ...
        public async Task IsDisplayable_NotEmptyOperation_ListType()
        {
            ...
            await _optionSettingHandler.SetOptionSettingValue(subnetsSetting, new SortedSet<string> { "subnet-1234abcd" });
