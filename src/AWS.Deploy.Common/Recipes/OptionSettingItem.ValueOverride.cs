...
namespace AWS.Deploy.Common.Recipes
{
    ...
    public partial class OptionSettingItem
    {
        ...
        /// </exception>
        public async Task SetValue(IOptionSettingHandler optionSettingHandler, object valueOverride, IOptionSettingItemValidator[] validators, bool skipValidation)
        {
            if (!skipValidation)
            {
                var isValid = true;
            ...
            else
            {
                ...
                foreach (var childOptionSetting in ChildOptionSettings)
                {
                    ...
                    {
                        await optionSettingHandler.SetOptionSettingValue(childOptionSetting, childValueOverride, skipValidation: skipValidation);
                    }
                }
            }
        }
